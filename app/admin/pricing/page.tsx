...
export default async function PricingPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <p className="text-xs font-semibold tracking-[0.18em] text-stone-400 uppercase">Pricing</p>
        <h1 className="mt-3 text-4xl font-light tracking-tight text-stone-900 sm:text-5xl">Pricing</h1>
