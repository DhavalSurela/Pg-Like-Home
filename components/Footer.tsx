                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link href="/rooms" className="hover:text-blue-400 transition-colors">Rooms & Pricing</Link></li>
                            <li><Link href="/facilities" className="hover:text-blue-400 transition-colors">Facilities</Link></li>
                            <li><Link href="/food" className="hover:text-blue-400 transition-colors">Food Menu</Link></li>
                            <li><Link href="/rules" className="hover:text-blue-400 transition-colors">Rules</Link></li>
